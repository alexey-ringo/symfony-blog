...
class PostService implements PostServiceInterface
{
     ...
     */
    public function handleCreate(FormInterface $form, Post $post): PostServiceInterface
    {
     ...
     * @return PostServiceInterface
     */
    public function handleUpdate(FormInterface $form,Post $post): PostServiceInterface
    {
        $image = $form->get('image')->getData();
